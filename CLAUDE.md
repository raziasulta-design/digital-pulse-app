...
Digital Pulse is a web portal replacing scattered spreadsheets with a live dashboard for activity logging, profiles, and analytics — built on Next.js + Supabase + Vercel, demo-first without a login wall in v1.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "324124151+raziasulta-design@users.noreply.github.com"
  git config user.name "raziasulta-design"
  ```
